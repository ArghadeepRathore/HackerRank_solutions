...
**Difficulty:** Easy  
**Topics:** N/A  
**HackerRank URL:** [Conditional Statements](https://www.hackerrank.com/challenges/c-tutorial-conditional-if-else/problem)
...
```cpp
// HackerRank Problem: Conditional Statements
