...
**Difficulty:** Easy  
**Topics:** N/A  
**HackerRank URL:** [Boxes through a Tunnel](https://www.hackerrank.com/challenges/too-high-boxes/problem)
...
The height of the tunnel  feet and the width can be assumed to be infinite. A box can be carried through the tunnel only if its height is strictly less than the tunnel's height. Find the volume of each box that can be successfully transported to the other end of the tunnel.
...
```c
// HackerRank Problem: Boxes through a Tunnel
